...
export CFLAGS="$RPM_OPT_FLAGS -g -O2" CXXFLAGS="$RPM_OPT_FLAGS -g -O2"
...
%changelog
* Sat Mar 24 2018 Arun Babu Neelicattu <arun.neelicattu@gmail.com> - 1.3.2-1
- Update to mosh 1.3.2
- Update source tarball URL
- Ensure builds work under EL
